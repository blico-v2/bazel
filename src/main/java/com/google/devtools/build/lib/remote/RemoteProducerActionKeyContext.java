...
final class RemoteProducerActionKeyContext implements ProducerActionKeyContext {
  ...
  public ActionKey computeActionKey(
    ...
    SpawnExecutionContext context =
        new DigestOnlySpawnExecutionContext(
            spawn, inputMetadataProvider, artifactExpander, artifactPathResolver);
  ...
  private final class DigestOnlySpawnExecutionContext implements SpawnExecutionContext {
    ...
    public SortedMap<PathFragment, ActionInput> getInputMapping(
      ...
      return spawnInputExpander.getInputMapping(
          spawn, artifactExpander, inputMetadataProvider, baseDirectory);
    }
